...
"px",height:d+"px"})}if(c.DeviceMotionEvent&&("auto"==this.options.controlMethod||"motion"==this.options.controlMethod))c.addEventListener("devicemotion",function(b){a.motion.ax=5*b.accelerationIncludingGravity.x;a.motion.ay=5*b.accelerationIncludingGravity.y;a.motion.az=5*b.accelerationIncludingGravity.z},!1),clearInterval(this.timer),this.timer=setInterval(b.proxy(a._track,a),25);else if(c.DeviceOrientationEvent&&("auto"==this.options.controlMethod||"orientation"==this.options.controlMethod))c.addEventListener("deviceorientation",
